export default (ModelClass, deserialize, serialize) => {
  return (target, key, descriptor) => {
    return {
      ...
      get() {
        ...
        this[Symbol.for('#meta')].attributes[key].store = ModelClass.getStore();
        this[Symbol.for('#meta')].attributes[key].relatedId = this.id;
        const _descriptor = {
          enumerable: descriptor.enumerable,
